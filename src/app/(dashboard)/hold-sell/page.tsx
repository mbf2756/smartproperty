...
export default function Page() {
  return (
    <div>
      <DashboardTopbar title="Hold vs Sell Modeller" subtitle="Model net proceeds across multiple future sale dates with CGT" />
      <div style={{ padding: '48px 40px', maxWidth: 680 }}>
        <div style={{ background: '#1A2F1A', borderRadius: 20, padding: '40px', textAlign: 'center' }}>
          ...
          <h2 style={{ fontSize: 22, fontWeight: 700, color: 'white', marginBottom: 12 }}>Hold vs Sell Modeller</h2>
          <p style={{ fontSize: 14, color: 'rgba(255,255,255,0.5)', lineHeight: 1.7, maxWidth: 420, margin: '0 auto 24px' }}>
            See exact net proceeds for selling now vs holding 1, 3, 5, 7 or 10 more years — with CGT calculated at your marginal rate and the 50% discount applied.
          </p>
